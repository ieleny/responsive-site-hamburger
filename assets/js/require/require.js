...
(function(ba) {
    ...
    function ia(b) {
        ...
        function G(a, f, b) {
            ...
            z(a.depMaps, function(e, c) {
                var d = e.id
                  , g = m(q, d);
                g && (!a.depMatched[c] && !b[d]) && (m(f, d) ? (a.defineDep(c, r[d]),
                a.check()) : G(g, f, b))
            }),
            b[e] = !0)
        }
        function E() {
            ...
            if (!X) {
                ...
                H(W, function(b) {
                    a = b.map;
                    f = a.id;
                    if (b.enabled && (a.isDefine || i.push(b),
                    !b.error))
                        if (!b.inited && n)
                            p(f) ? g = e = !0 : (c.push(f),
                            d(f));
                        else if (!b.inited && (b.fetched && a.isDefine) && (g = !0,
                        !a.prefix))
                            return l = !1
                });
                if (n && c.length)
            ...
            callPlugin: function() {
                ...
                u(d, "defined", v(this, function(e) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        e = l(a.prefix + "!" + d, this.map.parentMap),
                        u(e, "defined", v(this, function(a) {
                            this.init([], function() {
                                return a
                            }, null, {
                                enabled: !0,
        ...
        k = {
            ...
            makeRequire: function(a, f) {
                ...
                a || (d.undef = function(b) {
                    ...
                    delete V[c.url];
                    delete aa[b];
                    d && (d.events.defined && (aa[b] = d.events),
                    y(b))
                }
                );
                return d
    ...
    if ("undefined" === typeof define) {
        ...
        if (A && (y = x.head = document.getElementsByTagName("head")[0],
        E = document.getElementsByTagName("base")[0]))
        ...
        h.load = function(b, c, d) {
            ...
            if (A)
                ...
                g.attachEvent && !(g.attachEvent.toString && 0 > g.attachEvent.toString().indexOf("[native code")) && !Z ? (Q = !0,
        ...
        define = function(b, c, d) {
            ...
            c = null);
            !c && J(d) && (c = [],
            d.length && (d.toString().replace(ma, "").replace(na, function(b, d) {
                c.push(d)
            }),
            ...
            if (Q) {
                ...
                g = G[h.getAttribute("data-requirecontext")])
            }
